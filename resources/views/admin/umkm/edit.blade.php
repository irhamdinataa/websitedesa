...
<div class="row">
    <form method="POST" action="/admin/umkm/{{ $umkm->id }}" enctype="multipart/form-data">
        @method('put')
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="produk" id="produk" value="{{ old('produk', $umkm->produk) }}">
                            @error('produk')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="slug" id="slug" value="{{ old('slug', $umkm->slug) }}">
                            @error('slug')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" class="form-control" name="harga" id="harga" value="{{ old('harga',$umkm->harga) }}">
                            </div>
                            @error('harga')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="editor" name="deskripsi" rows="10">{{ old('deskripsi',$umkm->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="col-lg-4">
               <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            <img src="{{ asset('storage/' .$umkm->foto) }}" class="img-preview img-fluid mb-3 mt-2" id="preview" style="border-radius: 5px; max-height:300px; overflow:hidden;"><br>
